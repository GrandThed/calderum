...
class RoomDesignSystem {
  ...
  static const double spacingXl = 32.0;  // For large gaps between major components
  ...
  static const double primarySection = spacingXl;    // 32px - Between major sections
  static const double secondarySection = spacingLg;  // 24px - Between sub-sections
  ...
  static BoxDecoration roomInfoCardDecoration(Color surfaceColor) => BoxDecoration(
    color: surfaceColor.withValues(alpha: 0.8),
    borderRadius: BorderRadius.circular(radiusMedium),
    boxShadow: shadowLevel2,
  );

  static BoxDecoration settingsPanelDecoration(Color surfaceColor) => BoxDecoration(
    color: surfaceColor.withValues(alpha: 0.8),
    borderRadius: BorderRadius.circular(radiusMedium),
    boxShadow: shadowLevel1,
  );

  static BoxDecoration playerCardDecoration(Color surfaceColor, bool isCurrentUser, Color primaryColor) => BoxDecoration(
    color: surfaceColor.withValues(alpha: 0.8),
    borderRadius: BorderRadius.circular(radiusLarge),
    boxShadow: isCurrentUser ? primaryGlow(primaryColor) : shadowLevel1,
  );

  static BoxDecoration actionButtonDecoration(Color buttonColor) => BoxDecoration(
    color: buttonColor,
    borderRadius: BorderRadius.circular(radiusMedium),
    boxShadow: shadowLevel2,
  );
